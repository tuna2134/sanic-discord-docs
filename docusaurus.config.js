...
const config = {
  title: 'sanic-discord',
  tagline: 'Easy to use discord api with sanic.',
  url: 'https://tuna2134.github.io',
  baseUrl: '/sanic-discord-docs/',
  onBrokenLinks: 'throw',
  onBrokenMarkdownLinks: 'warn',
  favicon: 'img/favicon.ico',
  organizationName: 'tuna2134', // Usually your GitHub org/user name.
  projectName: 'sanic-discord-docs', // Usually your repo name.
